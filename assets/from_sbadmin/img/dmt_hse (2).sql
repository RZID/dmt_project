...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jun 2020 pada 09.32
...
CREATE TABLE `ins_dmt` (
  ...
  `ins6_ins` varchar(255) NOT NULL,
  `ins7_ins` varchar(255) NOT NULL,
  `ins8_ins` varchar(255) NOT NULL,
  `ins9_ins` varchar(255) NOT NULL,
  `ins10_ins` varchar(255) NOT NULL,
  ...
  `sesins6_ins` int(255) NOT NULL,
  `sesins7_ins` int(255) NOT NULL,
  `sesins8_ins` int(255) NOT NULL,
  `sesins9_ins` int(255) NOT NULL,
  `sesins10_ins` int(255) NOT NULL,
  ...
  `beasesins6_ins` int(255) NOT NULL,
  `beasesins7_ins` int(255) NOT NULL,
  `beasesins8_ins` int(255) NOT NULL,
  `beasesins9_ins` int(255) NOT NULL,
  `beasesins10_ins` int(255) NOT NULL,
...
CREATE TABLE `opr_dmt` (
  ...
  `id_plth` int(20) NOT NULL,
  `jmlpsrt_plth` int(255) NOT NULL,
  `glsarfas_opr` varchar(255) NOT NULL,
  `dokumen_opr` varchar(255) NOT NULL,
  `addcost_opr` int(255) NOT NULL,
  `addcostdesk_opr` varchar(255) NOT NULL,
  `addcostfile_opr` varchar(255) NOT NULL,
  `pkba_opr` varchar(255) NOT NULL,
  `file_opr` varchar(255) NOT NULL,
  `filesarfasunique_opr` varchar(255) NOT NULL,
  `filepkbaunique_opr` varchar(255) NOT NULL,
  `fileaddcostunique_opr` varchar(255) NOT NULL,
...
--
-- Struktur dari tabel `realisasi_dmt`
--

CREATE TABLE `realisasi_dmt` (
  `id_realisasi` int(11) NOT NULL,
  `jnsplth_realisasi` varchar(255) NOT NULL,
  `nama_realisasi` varchar(255) NOT NULL,
  `batch_realisasi` int(20) NOT NULL,
  `tglmulai_realisasi` int(255) NOT NULL,
  `tglsls_realisasi` int(255) NOT NULL,
  `lokasi_realisasi` varchar(255) NOT NULL,
  `durasi_realisasi` int(255) NOT NULL,
  `jmlsesi_realisasi` int(255) NOT NULL,
  `undpersero_realisasi` int(255) NOT NULL,
  `undnonpersero_realisasi` int(255) NOT NULL,
  `dtgpersero_realisasi` int(255) NOT NULL,
  `dtgnonpersero_realisasi` int(255) NOT NULL,
  `lndhours_realisasi` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indeks untuk tabel `realisasi_dmt`
--
ALTER TABLE `realisasi_dmt`
...
--
ALTER TABLE `pesertakeu_dmt`
  MODIFY `id_pesertakeu` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `pesertapnd_dmt`
--
ALTER TABLE `pesertapnd_dmt`
  MODIFY `id_pesertapnd` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT untuk tabel `realisasi_dmt`
--
ALTER TABLE `realisasi_dmt`
