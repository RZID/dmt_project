                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="modal-footer">
                            <button class="btn btn-secondary" id="delins_data" type="button" data-dismiss="modal">Tutup</button>
                          </div>
        ...
        success: function(data2) {
          $(document).ready(function() {
            ...
            $.each(data2, function(i, item) {
              $("#ins_data").append("<div class='row'><div class='col-xl col-lg'>Nomer Instruktur</div> : <div class='col-xl col-lg'>" + data2[i].no_ins + "</div> </div> <div class='row'> <div class='col-xl col-lg'>Instruktur</div> : <div class='col-xl col-lg'>" + data2[i].ins_ins + "</div> </div> <div class='row'> <div class='col-xl col-lg'>Tanggal Mulai Ajar Instruktur</div> : <div class='col-xl col-lg'>" + $.format.date(new Date(data2[i].tglmulaiajar_ins * 1000), 'dd MMMM yyyy') + "</div> </div> <div class='row'> <div class='col-xl col-lg'>Tanggal Selesai Ajar Instruktur</div> : <div class='col-xl col-lg'>" + $.format.date(new Date(data2[i].tgldoneajar_ins * 1000), 'dd MMMM yyyy') + "</div> </div> <div class='row'> <div class='col-xl col-lg'>Sesi Instruktur </div> : <div class='col-xl col-lg'>" + data2[i].sesins_ins + "</div> </div> <div class='row'> <div class='col-xl col-lg'>Biaya & Honor Transport Instruktur </div> : <div class='col-xl col-lg'>" + data2[i].beasesins_ins + "</div> </div> <div class='row'> <div class='col-xl col-lg'>Surat Undangan</div> : <div class='col-xl col-lg'><a href='<?= base_url("assets/uploaded_file/") ?>" + data2[i].surund_ins + "'>" + data2[i].surund_ins + "</a></div> </div><br>");
            });
            <?php
