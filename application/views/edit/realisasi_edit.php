                ...
                <div class="col-xl-12 col-lg-7">
                  <form class="namapelatihan" method="POST" action="<?= base_url("user/core_realisasi_core"); ?>">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" name="real1" value="<?= $row["jnsplth_realisasi"] ?>">
                    </div>

                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-secondary">Nama Pelatihan</h6>
                      <input type="text" class="form-control form-control-user" name="real2" value="<?= $row["nama_realisasi"] ?>">
                    </div>

                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-secondary">Batch</h6>
                      <input type="number" class="form-control form-control-user" name="real3" value="<?= $row["batch_realisasi"] ?>">
                    </div>

                    <div class="row">
                      <div class="form-group col-lg">
                        <h6 class="m-0 font-weight-bold text-secondary">Tanggal Mulai</h6>
                        <input type="date" class="form-control form-control-user" name="real4" value="<?= date("Y-m-d", $row["tglmulai_realisasi"]) ?>">
                      </div>
                      <div class="form-group col-lg">
                        <h6 class="m-0 font-weight-bold text-secondary">Tanggal Selesai</h6>
                        <input type="date" class="form-control form-control-user" name="real5" value="<?= date("Y-m-d", $row["tglsls_realisasi"]) ?>">
                      </div>
                    </div>

                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-secondary">Lokasi Pelatihan</h6>
                      <input type="text" class="form-control form-control-user" name="real6" value="<?= $row["lokasi_realisasi"] ?>">
                    </div>
                    <div class="form-group">
