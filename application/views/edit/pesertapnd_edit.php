          ...
          <div class="row">
            ...
            <div class="col-xl-12 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <br>
                <div class="col-xl-12 col-lg-7">
                  <form class="namapelatihan" enctype="multipart/form-data" action="<?= base_url("user/core_peserta_pnd") ?>" method="post">
                    ...
                    <br>
                    <h5>Data Peserta (PND)</h5>
                    <hr>
                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-secondary">Tarif Pelatihan</h6>
                      <input type="number" class="form-control form-control-user" placeholder="Tarif Pelatihan" name="psrtpnd1" value="<?= $whdb2['trfplth_pesertapnd'] ?>">
                    </div>
                    ...
                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-secondary">Nama PT Yang Mengikuti</h6>
                      <input type="text" class="form-control form-control-user" placeholder="Nama PT Yang Mengikuti" name="psrtpnd3" value="<?= $whdb2['jmldtgh_pesertapnd'] ?>">
                    </div>
                    <div class="form-group">
                      <h6 class="m-0 font-weight-bold text-secondary">Surat Undangan</h6>
                      <div class="custom-file" id="customFile" lang="es">
                        <input type="file" class="custom-file-input" id="surund" name="psrtpnd4" aria-describedby="fileHelp">
                        <label class="custom-file-label" for="surund">
                          Dokumen Sebelumnya : <?= $whdb2['surund_pesertapnd'] ?>
                        </label>
                      </div>
                    </div>
                    <!-- End Example events -->
                    <p></p>
                    <div class="form-group">
                      <input dbval="<?= $whdb2['status_pesertapnd'] ?>" type="checkbox" name="status" id="status" value="Completed" placeholder="" aria-describedby="helpId">
                      <label for="status">Selesaikan Status Kelengkapan Peserta (PND)</label>
                    </div>
            ...
            <!-- Scripting With JS -->
            <script>
              document.querySelector('#surund').addEventListener('change', function(e) {
                var fileName = document.getElementById("surund").files[0].name;
